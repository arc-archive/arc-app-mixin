  ...
  class ArcAppMixinImpl extends base {
    static get properties() {
      return {
         ...
         */
        componentsDir: {type: String, value: ''},
        /**
         ...
         * @type {String}
         */
        page: {type: String, value: 'request'},
        /**
         ...
         * Browser version
         */
        browserVersion: {type: String, value: 'unknown'},
        /**
         * Application channel, `stable`, `beta`, `dev`
         */
        appChannel: {type: String, value: 'stable'},
        /**
    ...
    _reportComponentLoadingError(url) {
      console.warn(`Unable to load component from ${url}`);
    }
    /**
    ...
    initSettings() {
      ...
      if (!e.defaultPrevented) {
        ...
        console.warn(`[arc-app] Settings provider not found`);
      ...
      .then((settings) => {
        ...
        this.set('historyEnabled', historyEnabled);
        return settings;
      });
    }
    /**
     ...
     */
    _requestAuthToken() {
      console.warn('_requestAuthToken() not implemented.');
    }
    /**
